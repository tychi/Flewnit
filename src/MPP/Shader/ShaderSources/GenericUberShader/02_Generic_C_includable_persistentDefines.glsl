...
//{
	...
	#define SHADER_LIGHTING_FEATURE_GLOBAL_LIGHTING		1<<1
	#define SHADER_LIGHTING_FEATURE_DECAL_TEXTURING		1<<2
	#define SHADER_LIGHTING_FEATURE_NORMAL_MAPPING		1<<3
	#define SHADER_LIGHTING_FEATURE_CUBE_MAPPING		1<<4
	#define SHADER_LIGHTING_FEATURE_AMBIENT_OCCLUSION	1<<5
