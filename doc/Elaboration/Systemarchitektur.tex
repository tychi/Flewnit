...
\label{sec:statusImplementation}
	...
	Fluid-Simulation inklusive der Visualisierung des Uniform Grid, eine weitere Box mit \lstinline|DebugDrawMaterial|,
	...
	Alle Objekte sind mit meheren Lichtquellen, sowohl spot als auch point lights, in einem Render-Pass beleuchtet.
	...
	Details werden im Verlauf des Abschnitts \ref{sec:simulation} erläutert.\\
  	...
  	Ich wollte dann auch meiner "`ganz oder gar nicht"'-Linie in diesem System treu bleiben, und werde die Visualiserung
  	...
  	Weiterhin fehlen noch sämtliche erweiterten Features und Optimierungen bei der mechanischen Fluid-Simulation.
  	...
  	auf der Realisierung von kombinierbaren Effekten, nicht auf künstlerischem Anspruch. Dennoch ist die Fertigstellung
  	des Scene Loaders in Planung.
