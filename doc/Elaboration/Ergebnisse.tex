...
\todo{wtf beschreiben darüber dass non.local mem-stuff selbst auf der non-cahed gtx280 flüssiger läufgt WTF
aber jetzt zu müde }
...
PingPongBuffer* mObjectInfoPiPoBuffer; //uint ping pong buffer	
		...
		\todo{ins paper schaun und uberprüfen falls zeit ist}
